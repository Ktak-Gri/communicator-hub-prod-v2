  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-2">
            <div onClick={() => navigate('learning-test')} className="bg-white p-6 rounded-[2rem] border border-slate-200 hover:shadow-xl cursor-pointer group relative overflow-hidden transition-all hover:-translate-y-1">
            ...
            <div onClick={() => navigate('learning-trainer')} className="bg-white p-6 rounded-[2rem] border border-slate-200 hover:shadow-xl cursor-pointer group relative overflow-hidden transition-all hover:-translate-y-1">
