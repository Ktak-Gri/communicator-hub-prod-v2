...
/**
 * 各センターの業務詳細定義 (V6.33.02: Precise Plan Matching)
...
const CenterSummaryPage: React.FC<CenterSummaryPageProps> = ({ masterSettings }) => {
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden animate-fade-in max-w-7xl mx-auto">
            <div className="px-4 py-2.5 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-[10px] text-slate-400 font-bold mt-0.5 ml-3.5 uppercase tracking-wider">Center Role & Scope Reference</p>
                </div>
            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse text-xs min-w-[950px]">
                    <thead className="bg-[#84b547] text-white font-black">
                        <tr>
                            <th className="px-3 py-2.5 border-r border-white/20 text-center w-28 whitespace-nowrap">分類</th>
                            <th className="px-3 py-2.5 border-r border-white/20 text-left w-60">センター名</th>
                            <th className="px-3 py-2.5 border-r border-white/20 text-center w-24">略称</th>
                            <th className="px-3 py-2.5 text-left">主な対応内容</th>
                        </tr>
                    </thead>
            ...
            <div className="px-4 py-2 bg-slate-50 border-t border-slate-200 text-[9px] text-slate-300 font-black text-right uppercase tracking-widest">
                Copyright © UT Group Co., Ltd. | Communicator Training Hub
            </div>
        </div>
    );
};
